...
const Kategori = () => {
  ...
  const [jenisKategori, setJenisKategori] = useState("Utama");
  ...
  const [chartData, setChartData] = useState({
    labels: ['Makanan', 'Transportasi', 'Hiburan', 'Belanja', 'Kesehatan', 'Lainnya'],
    datasets: [
      {
  ...
  const fetchCategoryData = useCallback(() => {
    // Mock data that varies by kategori
    const mockDataByType = {
      ...
      "Pemasukan": {
        labels: ['Gaji', 'Bonus', 'Hadiah', 'Investasi', 'Penjualan', 'Lainnya'],
        data: [2500000, 500000, 100000, 350000, 200000, 50000]
      },
      "Keduanya": {
        labels: ['Makanan', 'Transportasi', 'Hiburan', 'Gaji', 'Investasi', 'Lainnya'],
        data: [250000, 150000, 100000, 2500000, 350000, 50000]
      }
    };
    
    // Apply variation based on date range
    ...
    const variationFactor = daysDiff / 30;
    
    const selectedTypeData = mockDataByType[kategori];
    const variedData = selectedTypeData.data.map(value => 
      Math.round(value * (0.7 + variationFactor * Math.random()))
    );
    
    setChartData({
      labels: selectedTypeData.labels,
      datasets: [
        {
          data: variedData,
          backgroundColor: [
  ...
  }, [dariTanggal, keTanggal, kategori]);
            ...
            <div style={{ 
              ...
              <div style={{ marginBottom: "10px" }}>
                <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "5px" }}>
                  <span>
                    {kategori === "Pengeluaran" ? "Total Pengeluaran:" : 
                     kategori === "Pemasukan" ? "Total Pemasukan:" : 
                     "Total Transaksi:"}
                  </span>
                  <span style={{ fontWeight: "500" }}>
                    Rp {chartData.datasets[0].data.reduce((a, b) => a + b, 0).toLocaleString()}
                  </span>
                </div>
                <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "5px" }}>
                ...
                <div style={{ display: "flex", justifyContent: "space-between" }}>
                  ...
                  <span style={{ fontWeight: "500" }}>
                    {(() => {
                      ...
                      const percentage = Math.round((chartData.datasets[0].data[maxIndex] / total) * 100);
              ...
              <hr style={{ margin: "15px 0", borderColor: "#ddd", borderStyle: "solid" }} />
              
              <table style={{ width: "100%", borderCollapse: "collapse" }}>
                <thead>
                  <tr>
                    <th style={{ textAlign: "left", padding: "5px 0" }}>Kategori</th>
                    <th style={{ textAlign: "right", padding: "5px 0" }}>Jumlah</th>
            ...
            <div style={{ 
              ...
              <label style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                <div style={{ 
                  ...
                  height: "18px", 
                  borderRadius: "50%", 
                  border: `2px solid ${kategori === "Pengeluaran" ? "#3498db" : "#ccc"}`,
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
                  position: "relative"
              ...
              <label style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                <div style={{ 
                  ...
                  height: "18px", 
                  borderRadius: "50%", 
                  border: `2px solid ${kategori === "Pemasukan" ? "#3498db" : "#ccc"}`,
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center" 
                }}>
              ...
              <label style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                <div style={{ 
                  ...
                  height: "18px", 
                  borderRadius: "50%", 
                  border: `2px solid ${kategori === "Keduanya" ? "#3498db" : "#ccc"}`,
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center" 
                }}>
            ...
            <div style={{ 
              ...
              <label style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                <div style={{ 
                  ...
                  height: "18px", 
                  borderRadius: "50%", 
                  border: `2px solid ${tipeDiagram === "Lingkaran" ? "#3498db" : "#ccc"}`,
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center" 
                }}>
              ...
              <label style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                <div style={{ 
                  ...
                  height: "18px", 
                  borderRadius: "50%", 
                  border: `2px solid ${tipeDiagram === "Batang" ? "#3498db" : "#ccc"}`,
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center" 
                }}>
            ...
            <div style={{ display: "flex", gap: "20px" }}>
              <label style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                <div style={{ 
                  ...
                  height: "18px", 
                  borderRadius: "50%", 
                  border: `2px solid ${jenisKategori === "Utama" ? "#3498db" : "#ccc"}`,
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center" 
                }}>
